...
class UserConversationInstance(InstanceResource):
    ...
    def __init__(self, version: Version, payload: Dict[str, Any], user_sid: str, conversation_sid: Optional[str] = ...) -> None:
        ...
...
class UserConversationContext(InstanceContext):
    def __init__(self, version: Version, user_sid: str, conversation_sid: str) -> None:
        """
...
class UserConversationList(ListResource):
    def __init__(self, version: Version, user_sid: str) -> None:
        """
