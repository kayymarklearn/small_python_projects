...
class InteractionList(ListResource):
    ...
    def stream(self, limit: Optional[int] = ..., page_size: Optional[int] = ...) -> Iterator[InteractionInstance]:
        """
    ...
    async def stream_async(self, limit: Optional[int] = ..., page_size: Optional[int] = ...) -> AsyncIterator[InteractionInstance]:
        """
    ...
    def list(self, limit: Optional[int] = ..., page_size: Optional[int] = ...) -> List[InteractionInstance]:
        """
    ...
    async def list_async(self, limit: Optional[int] = ..., page_size: Optional[int] = ...) -> List[InteractionInstance]:
        """
    ...
    def page(self, page_token: Union[str, object] = ..., page_number: Union[int, object] = ..., page_size: Union[int, object] = ...) -> InteractionPage:
        """
    ...
    async def page_async(self, page_token: Union[str, object] = ..., page_number: Union[int, object] = ..., page_size: Union[int, object] = ...) -> InteractionPage:
        """
