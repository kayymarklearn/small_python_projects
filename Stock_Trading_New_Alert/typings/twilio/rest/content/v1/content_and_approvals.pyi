...
class ContentAndApprovalsList(ListResource):
    ...
    def stream(self, limit: Optional[int] = ..., page_size: Optional[int] = ...) -> Iterator[ContentAndApprovalsInstance]:
        """
    ...
    async def stream_async(self, limit: Optional[int] = ..., page_size: Optional[int] = ...) -> AsyncIterator[ContentAndApprovalsInstance]:
        """
    ...
    def list(self, limit: Optional[int] = ..., page_size: Optional[int] = ...) -> List[ContentAndApprovalsInstance]:
        """
    ...
    async def list_async(self, limit: Optional[int] = ..., page_size: Optional[int] = ...) -> List[ContentAndApprovalsInstance]:
        """
    ...
    def page(self, page_token: Union[str, object] = ..., page_number: Union[int, object] = ..., page_size: Union[int, object] = ...) -> ContentAndApprovalsPage:
        """
    ...
    async def page_async(self, page_token: Union[str, object] = ..., page_number: Union[int, object] = ..., page_size: Union[int, object] = ...) -> ContentAndApprovalsPage:
        """
