...
class NewSigningKeyList(ListResource):
    ...
    def create(self, friendly_name: Union[str, object] = ...) -> NewSigningKeyInstance:
        """
    ...
    def create_with_http_info(self, friendly_name: Union[str, object] = ...) -> ApiResponse:
        """
        Create the NewSigningKeyInstance and return response metadata
    ...
    async def create_async(self, friendly_name: Union[str, object] = ...) -> NewSigningKeyInstance:
        """
    ...
    async def create_with_http_info_async(self, friendly_name: Union[str, object] = ...) -> ApiResponse:
        """
        Asynchronously create the NewSigningKeyInstance and return response metadata
