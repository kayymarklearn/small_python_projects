...
class SyncListPermissionInstance(InstanceResource):
    ...
    """
    def __init__(self, version: Version, payload: Dict[str, Any], service_sid: str, list_sid: str, identity: Optional[str] = ...) -> None:
        ...
    ...
    def update(self, read: bool, write: bool, manage: bool) -> SyncListPermissionInstance:
        """
    ...
    async def update_async(self, read: bool, write: bool, manage: bool) -> SyncListPermissionInstance:
        """
...
class SyncListPermissionContext(InstanceContext):
    def __init__(self, version: Version, service_sid: str, list_sid: str, identity: str) -> None:
        """
...
class SyncListPermissionList(ListResource):
    ...
    def stream(self, limit: Optional[int] = ..., page_size: Optional[int] = ...) -> Iterator[SyncListPermissionInstance]:
        """
    ...
    async def stream_async(self, limit: Optional[int] = ..., page_size: Optional[int] = ...) -> AsyncIterator[SyncListPermissionInstance]:
        """
    ...
    def list(self, limit: Optional[int] = ..., page_size: Optional[int] = ...) -> List[SyncListPermissionInstance]:
        """
    ...
    async def list_async(self, limit: Optional[int] = ..., page_size: Optional[int] = ...) -> List[SyncListPermissionInstance]:
        """
    ...
    def page(self, page_token: Union[str, object] = ..., page_number: Union[int, object] = ..., page_size: Union[int, object] = ...) -> SyncListPermissionPage:
        """
    ...
    async def page_async(self, page_token: Union[str, object] = ..., page_number: Union[int, object] = ..., page_size: Union[int, object] = ...) -> SyncListPermissionPage:
        """
